...
status = ['Jamming out to music!', 'Gaming', 'Sleeping!']

@client.event
async def on_ready():
    change_status.start()
    print("The Bot {0.user} is now online".format(client))
...
async def credits(ctx):
    await ctx.send('This Bot `Cyblog` has been made by `Kushal Shah`')
